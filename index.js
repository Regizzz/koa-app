...
// using 3rd party middleware(handlers) modules
...
//router.get('/user/:user/user', async function(ctx) {
...
app.use(router.routes()); // router.routes = function() { return async (ctx, next) => {} }
